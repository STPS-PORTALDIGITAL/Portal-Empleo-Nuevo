...
public class OfertaEmpleo implements Serializable {
	...
	private List<OfertaEmpleoConocimientoHerramienta> ofertaempleoConocimientoherramientas;

	//bi-directional many-to-one association to OfertaempleoHabilidadcompetencia
	@OneToMany(mappedBy="ofertaempleo")
	private List<OfertaEmpleoHabilidadCompetencia> ofertaempleoHabilidadcompetencias;
	...
	public List<OfertaEmpleoConocimientoHerramienta> getOfertaempleoConocimientoherramientas() {
		return this.ofertaempleoConocimientoherramientas;
	}

	public void setOfertaempleoConocimientoherramientas(List<OfertaEmpleoConocimientoHerramienta> ofertaempleoConocimientoherramientas) {
	...
	public List<OfertaEmpleoHabilidadCompetencia> getOfertaempleoHabilidadcompetencias() {
		return this.ofertaempleoHabilidadcompetencias;
	}

	public void setOfertaempleoHabilidadcompetencias(List<OfertaEmpleoHabilidadCompetencia> ofertaempleoHabilidadcompetencias) {
