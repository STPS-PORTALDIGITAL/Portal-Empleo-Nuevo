...
import sne.gob.mx.ws.rest.vo.RolesObjectVO;
...
public class RolesServiceImpl implements Service {
	final static Logger log = Logger.getLogger(RolesServiceImpl.class);
	
	/************************************************************************************
	 * NOMBRE:			Alta de Roles
	 * DESCRIPCIÓN:		Método que provee el alta de un Roles
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	...
	public ResponseVO alta(RequestVO vo) {
		RolesRequestVO 	in 				= new RolesRequestVO();
		RolesResponseVO 	out 			= new RolesResponseVO();
		RolesObjectVO 	obj				= new RolesObjectVO();
		...
		try {
			...
			vo.setClazz("RolesServiceImpl.class");
	 ...
	 * DESCRIPCIÓN:		Método que provee la baja de un Roles
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	 ...
	 * DESCRIPCIÓN:		Método que provee la consulta de un Roles
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	...
	/************************************************************************************
	 * NOMBRE:			Consulta de Roles x Id
	 * DESCRIPCIÓN:		Método que provee la consulta de un Roles x Id
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	 ...
	 * DESCRIPCIÓN:		Método que provee la modificacion de un Roles
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
