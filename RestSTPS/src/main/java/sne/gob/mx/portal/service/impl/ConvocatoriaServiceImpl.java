...
import sne.gob.mx.ws.rest.vo. ConvocatoriaObjectVO;
...
public class  ConvocatoriaServiceImpl implements Service {
	final static Logger log = Logger.getLogger( ConvocatoriaServiceImpl.class);
	
	/************************************************************************************
	 * NOMBRE:			Alta de  Convocatoria
	 * DESCRIPCIÓN:		Método que provee el alta de un  Convocatoria
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	...
	public ResponseVO alta(RequestVO vo) {
		 ConvocatoriaRequestVO 	in 				= new  ConvocatoriaRequestVO();
		 ConvocatoriaResponseVO 	out 			= new  ConvocatoriaResponseVO();
		 ConvocatoriaObjectVO 	obj				= new  ConvocatoriaObjectVO();
		...
		try {
			...
			vo.setClazz(" ConvocatoriaServiceImpl.class");
	 ...
	 * DESCRIPCIÓN:		Método que provee la baja de un  Convocatoria
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	 ...
	 * DESCRIPCIÓN:		Método que provee la consulta de un  Convocatoria
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	...
	/************************************************************************************
	 * NOMBRE:			Consulta de  Convocatoria x Id
	 * DESCRIPCIÓN:		Método que provee la consulta de un  Convocatoria x Id
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	 ...
	 * DESCRIPCIÓN:		Método que provee la modificacion de un  Convocatoria
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
