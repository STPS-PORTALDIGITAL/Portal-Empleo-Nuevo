...
import sne.gob.mx.ws.rest.vo.MunicipioObjectVO;
...
public class MunicipioServiceImpl implements Service {
	final static Logger log = Logger.getLogger(MunicipioServiceImpl.class);
	
	/************************************************************************************
	 * NOMBRE:			Alta de Municipio
	 * DESCRIPCIÓN:		Método que provee el alta de un Municipio
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	...
	public ResponseVO alta(RequestVO vo) {
		MunicipioRequestVO 	in 				= new MunicipioRequestVO();
		MunicipioResponseVO 	out 			= new MunicipioResponseVO();
		MunicipioObjectVO 	obj				= new MunicipioObjectVO();
		...
		try {
			...
			vo.setClazz("MunicipioServiceImpl.class");
	 ...
	 * DESCRIPCIÓN:		Método que provee la baja de un Municipio
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	 ...
	 * DESCRIPCIÓN:		Método que provee la consulta de un Municipio
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	...
	/************************************************************************************
	 * NOMBRE:			Consulta de Municipio x Id
	 * DESCRIPCIÓN:		Método que provee la consulta de un Municipio x Id
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	 ...
	 * DESCRIPCIÓN:		Método que provee la modificacion de un Municipio
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
