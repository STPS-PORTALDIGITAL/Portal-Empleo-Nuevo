...
import sne.gob.mx.ws.rest.vo.UbicacionObjectVO;
...
public class UbicacionServiceImpl implements Service {
	final static Logger log = Logger.getLogger(UbicacionServiceImpl.class);
	
	/************************************************************************************
	 * NOMBRE:			Alta de Ubicacion
	 * DESCRIPCIÓN:		Método que provee el alta de un Ubicacion
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	...
	public ResponseVO alta(RequestVO vo) {
		UbicacionRequestVO 	in 				= new UbicacionRequestVO();
		UbicacionResponseVO 	out 			= new UbicacionResponseVO();
		UbicacionObjectVO 	obj				= new UbicacionObjectVO();
		...
		try {
			...
			vo.setClazz("UbicacionServiceImpl.class");
	 ...
	 * DESCRIPCIÓN:		Método que provee la baja de un Ubicacion
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	 ...
	 * DESCRIPCIÓN:		Método que provee la consulta de un Ubicacion
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	...
	/************************************************************************************
	 * NOMBRE:			Consulta de Ubicacion x Id
	 * DESCRIPCIÓN:		Método que provee la consulta de un Ubicacion x Id
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	 ...
	 * DESCRIPCIÓN:		Método que provee la modificacion de un Ubicacion
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
