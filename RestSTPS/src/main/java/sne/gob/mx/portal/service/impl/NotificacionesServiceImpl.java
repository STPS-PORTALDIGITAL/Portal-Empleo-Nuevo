...
import sne.gob.mx.ws.rest.vo.NotificacionesObjectVO;
...
public class NotificacionesServiceImpl implements Service {
	final static Logger log = Logger.getLogger(NotificacionesServiceImpl.class);
	
	/************************************************************************************
	 * NOMBRE:			Alta de Notificaciones
	 * DESCRIPCIÓN:		Método que provee el alta de un Notificaciones
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	...
	public ResponseVO alta(RequestVO vo) {
		NotificacionesRequestVO 	in 				= new NotificacionesRequestVO();
		NotificacionesResponseVO 	out 			= new NotificacionesResponseVO();
		NotificacionesObjectVO 	obj				= new NotificacionesObjectVO();
		...
		try {
			...
			vo.setClazz("NotificacionesServiceImpl.class");
	 ...
	 * DESCRIPCIÓN:		Método que provee la baja de un Notificaciones
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	 ...
	 * DESCRIPCIÓN:		Método que provee la consulta de un Notificaciones
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	...
	/************************************************************************************
	 * NOMBRE:			Consulta de Notificaciones x Id
	 * DESCRIPCIÓN:		Método que provee la consulta de un Notificaciones x Id
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	 ...
	 * DESCRIPCIÓN:		Método que provee la modificacion de un Notificaciones
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
