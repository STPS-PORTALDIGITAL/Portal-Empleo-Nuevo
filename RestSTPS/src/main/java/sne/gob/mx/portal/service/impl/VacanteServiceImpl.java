...
import sne.gob.mx.ws.rest.vo.VacanteObjectVO;
...
public class VacanteServiceImpl implements Service {
	final static Logger log = Logger.getLogger(VacanteServiceImpl.class);
	
	/************************************************************************************
	 * NOMBRE:			Alta de Vacante
	 * DESCRIPCIÓN:		Método que provee el alta de un Vacante
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	...
	public ResponseVO alta(RequestVO vo) {
		VacanteRequestVO 	in 				= new VacanteRequestVO();
		VacanteResponseVO 	out 			= new VacanteResponseVO();
		VacanteObjectVO 	obj				= new VacanteObjectVO();
		...
		try {
			...
			vo.setClazz("VacanteServiceImpl.class");
	 ...
	 * DESCRIPCIÓN:		Método que provee la baja de un Vacante
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	 ...
	 * DESCRIPCIÓN:		Método que provee la consulta de un Vacante
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	...
	/************************************************************************************
	 * NOMBRE:			Consulta de Vacante x Id
	 * DESCRIPCIÓN:		Método que provee la consulta de un Vacante x Id
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	 ...
	 * DESCRIPCIÓN:		Método que provee la modificacion de un Vacante
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
