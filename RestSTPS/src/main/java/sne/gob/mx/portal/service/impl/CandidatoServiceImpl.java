...
import sne.gob.mx.ws.rest.vo.CandidatoObjectVO;
...
public class CandidatoServiceImpl implements Service {
	final static Logger log = Logger.getLogger(CandidatoServiceImpl.class);
	
	/************************************************************************************
	 * NOMBRE:			Alta de Candidato
	 * DESCRIPCIÓN:		Método que provee el alta de un Candidato
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	...
	public ResponseVO alta(RequestVO vo) {
		CandidatoRequestVO 	in 				= new CandidatoRequestVO();
		CandidatoResponseVO 	out 			= new CandidatoResponseVO();
		CandidatoObjectVO 	obj				= new CandidatoObjectVO();
		...
		try {
			...
			vo.setClazz("CandidatoServiceImpl.class");
	 ...
	 * DESCRIPCIÓN:		Método que provee la baja de un Candidato
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	 ...
	 * DESCRIPCIÓN:		Método que provee la consulta de un Candidato
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	...
	/************************************************************************************
	 * NOMBRE:			Consulta de Candidato x Id
	 * DESCRIPCIÓN:		Método que provee la consulta de un Candidato x Id
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	 ...
	 * DESCRIPCIÓN:		Método que provee la modificacion de un Candidato
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
