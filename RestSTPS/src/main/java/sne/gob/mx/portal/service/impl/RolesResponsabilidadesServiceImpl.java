...
import sne.gob.mx.ws.rest.vo.RolesResponsabilidadesObjectVO;
...
public class RolesResponsabilidadesServiceImpl implements Service {
	final static Logger log = Logger.getLogger(RolesResponsabilidadesServiceImpl.class);
	
	/************************************************************************************
	 * NOMBRE:			Alta de RolesResponsabilidades
	 * DESCRIPCIÓN:		Método que provee el alta de un RolesResponsabilidades
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	...
	public ResponseVO alta(RequestVO vo) {
		RolesResponsabilidadesRequestVO 	in 				= new RolesResponsabilidadesRequestVO();
		RolesResponsabilidadesResponseVO 	out 			= new RolesResponsabilidadesResponseVO();
		RolesResponsabilidadesObjectVO 	obj				= new RolesResponsabilidadesObjectVO();
		...
		try {
			if (security.checkPermisos(vo)) {
				...
				in = (RolesResponsabilidadesRequestVO)vo;
				obj = in.getVo();
			...
			vo.setClazz("RolesResponsabilidadesServiceImpl.class");
	 ...
	 * DESCRIPCIÓN:		Método que provee la baja de un RolesResponsabilidades
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	 ...
	 * DESCRIPCIÓN:		Método que provee la consulta de un RolesResponsabilidades
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	...
	/************************************************************************************
	 * NOMBRE:			Consulta de RolesResponsabilidades x Id
	 * DESCRIPCIÓN:		Método que provee la consulta de un RolesResponsabilidades x Id
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	 ...
	 * DESCRIPCIÓN:		Método que provee la modificacion de un RolesResponsabilidades
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
