...
import sne.gob.mx.ws.rest.vo.CitaAtencionObjectVO;
...
public class CitaAtencionServiceImpl implements Service {
	final static Logger log = Logger.getLogger(CitaAtencionServiceImpl.class);
	
	/************************************************************************************
	 * NOMBRE:			Alta de CitaAtencion
	 * DESCRIPCIÓN:		Método que provee el alta de un CitaAtencion
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	...
	public ResponseVO alta(RequestVO vo) {
		CitaAtencionRequestVO 	in 				= new CitaAtencionRequestVO();
		CitaAtencionResponseVO 	out 			= new CitaAtencionResponseVO();
		CitaAtencionObjectVO 	obj				= new CitaAtencionObjectVO();
		...
		try {
			...
			vo.setClazz("CitaAtencionServiceImpl.class");
	 ...
	 * DESCRIPCIÓN:		Método que provee la baja de un CitaAtencion
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	 ...
	 * DESCRIPCIÓN:		Método que provee la consulta de un CitaAtencion
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	...
	/************************************************************************************
	 * NOMBRE:			Consulta de CitaAtencion x Id
	 * DESCRIPCIÓN:		Método que provee la consulta de un CitaAtencion x Id
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
	 ...
	 * DESCRIPCIÓN:		Método que provee la modificacion de un CitaAtencion
	 * AUTOR:			JDGR
	 * FECHA:			07/May/2020
	 * CONTRATO:		TBD
	 * --------------------------H I S T Ó R I C O---------------------------------------
